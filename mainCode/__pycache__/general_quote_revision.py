    ...
    try:
        ...
        def addRow(quotedf,check=None):
            ...
            #--------- old ---------
                    ...
                    e_cost.append((ttk.Entry(entryFrame, width=5, validate = "key",textvariable=e_cost_var), e_cost_var))
                    ...
                    freightIncured.append((ttk.Entry(entryFrame, width=5, validate = "key",textvariable=freightIncured_var), freightIncured_var))
                    ...
                    freightCharged.append((ttk.Entry(entryFrame, width=5, validate = "key",textvariable=freightCharged_var), freightCharged_var))
