...
def no_order_why(root,conn):
    ...
    try:
        ...
        Quotenum = ttk.Entry(entryFrame1, textvariable=qn, background = 'white',width = 10)
        Quotenum.grid(row=1,column=0,sticky=tk.EW,padx=10,pady=10)
        qn.set("*")

        preparedVar = tk.StringVar()
        preparedBox = ttk.Entry(entryFrame2, textvariable=preparedVar, background = 'white',width = 10)
        preparedBox.grid(row=1,column=0,sticky=tk.EW,padx=10,pady=10)
        preparedVar.set("*")

        salespersonVar = tk.StringVar()
        salespersonBox = ttk.Entry(entryFrame3, textvariable=salespersonVar, background = 'white',width = 10)
        salespersonBox.grid(row=1,column=0,sticky=tk.EW,padx=10,pady=10)
        salespersonVar.set("*")
        
        priceVar = tk.StringVar()
        priceBox = ttk.Entry(entryFrame1, textvariable=priceVar, background = 'white',width = 10)
        priceBox.grid(row=3,column=0,sticky=tk.EW,padx=10,pady=10)
        priceVar.set("*")

        TimeVar = tk.StringVar()
        TimeBox = ttk.Entry(entryFrame2, textvariable=TimeVar, background = 'white',width = 10)
        ...
        # fromId = ttk.Entry(entryFrame1, textvariable=fromIdVar, background = 'white',width = 10,validate = "key",
        #         validatecommand=(vcmd, '%P','%d'))
        ...
        # toId = ttk.Entry(entryFrame1, textvariable=toIdVar, background = 'white',width = 10,validate = "key",
        #         validatecommand=(vcmd, '%P','%d'))
        ...
        submitButton = ttk.Button(submitFrame,text="Submit")
